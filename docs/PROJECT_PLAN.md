...
- YouTube downloads now run a safe post-download enrichment pass: improve title/artist/album via MusicBrainz when match confidence is high, attempt better cover art via TheAudioDB, and otherwise preserve yt-dlp thumbnail metadata.
